# Copied from: https://github.com/NixOS/nixpkgs/pull/502388
{
  lib,
  config,
  pkgs,
...
in {
  ...
  config = lib.mkIf cfg.enable {
    ...
    # Synchronize the services with the unit files defined in the source package
    systemd.services = {
